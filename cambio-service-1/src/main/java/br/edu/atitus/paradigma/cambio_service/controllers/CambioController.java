...
@RestController
@RequestMapping("cambio-service1")
...
public class CambioController {
	...
	public ResponseEntity<CambioEntity> getCambio(
		...
		CambioEntity cambio = cambioRepository.findByOrigemAndDestino(origem, destino)
		         .orElseThrow(() -> new Exception("Câmbio não encontrado para essa origem e destino"));
		         
		cambio.setValorconvertido(valor * cambio.getFator());
		cambio.setAmbiente("Cambio-service1 run in port: " + porta);
